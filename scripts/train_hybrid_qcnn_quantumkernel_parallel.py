...
def run_train(args):
    ...
    EXPERIMENT_NAME = f"{dataset_name}_hybrid_qcnn_qkernel_parallel_{args.backend}"
    ...
    # Keep the same subset choice used previously if desired
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(train_dataset)):
        ...
        # Parallel kernel matrices via selected backend
        print("🔹 Kernel train ...")
